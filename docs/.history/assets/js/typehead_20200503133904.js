...
MyDateField.prototype = new jsGrid.Field({
  ...
  insertTemplate: function (value) {
      return this._insertPicker = $("<input class='date-picker'>").datetimepicker({timepicker:false,format:'d.m.Y'});
  },
  
  editTemplate: function (value) {
      return this._editPicker = $("<input class='date-picker'>").datetimepicker({timepicker:false,format:'d.m.Y'});
  },
